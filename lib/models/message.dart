...
class Message {
  ...
  factory Message.fromJson(Map<String, dynamic> json) {
    return Message(
      ...
      gameStatus: json.containsKey("gameStatus")
          ? GameStatus.fromJson(json["gameStatus"])
          : null,
      move: json.containsKey("move") ? Move.fromJson(json["move"]) : null,
      welcomeMessage: json.containsKey("welcomeMessage")
          ? WelcomeMessage.fromJson(json["welcomeMessage"])
          : null,
    );
  }
